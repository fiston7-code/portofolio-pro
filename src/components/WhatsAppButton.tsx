...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-24 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-2xl flex items-center justify-center hover:bg-[#20ba5a] transition-colors"
      aria-label="Contactez-nous sur WhatsApp"
    >
      {/* Ton logo WhatsApp en SVG */}
      <svg 
        viewBox="0 0 24 24" 
        width="30" 
        height="30" 
